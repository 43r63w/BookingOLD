...
namespace Booking.Infrustucture.Migrations
{
    /// <inheritdoc />
    public partial class ImplementIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Villas",
                columns: new[] { "Id", "CreateDate", "Description", "ImageUrl", "Name", "Occupancy", "Price", "Sqrt", "UpdateDate" },
                values: new object[,]
                {
                    { 1, null, null, "12345", "Royal Villa", 8, 500.0, 300, null },
                    { 2, null, null, "12345", "Premium Pool Villa", 6, 400.0, 250, null }
                });
